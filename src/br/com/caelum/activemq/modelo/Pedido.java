package br.com.caelum.activemq.modelo;
...
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD)		// diz para o JAXB para ele se basear nos atributos na conversão do Pedido para XML, ignorando os Getters and Setters
