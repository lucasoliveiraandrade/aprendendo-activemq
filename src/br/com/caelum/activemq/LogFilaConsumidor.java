...
public class LogFilaConsumidor {
    ...
    public static void main(String[] args) throws NamingException, JMSException {
        ...
        Destination filaLog = (Destination) context.lookup("log"); // Convenção do JNDI. Ver jndi.properties.

        MessageConsumer consumer = session.createConsumer(filaLog);
